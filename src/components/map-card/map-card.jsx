...
useEffect(() => {
    ...
    movie.filmingLocations.forEach( function (locations){
        ...
        //    console.log("locations.locations loop")
           testMarkers.push({location: location.location,
                name:location.name})
   ...
   //     console.log("fimlingLocations loop")
    ...
    if(itemsProcessed === movie.filmingLocations.length) {
     ...
     //   console.log(itemsProcessed)
        cameraCenter =  {lat: parseFloat(testMarkers[0].location[0]),
            lng: parseFloat(testMarkers[0].location[1])}
            console.log(cameraCenter)
    //serCenter isnt working right now
            ...
            >
                ...
                markers.map((marker, index) => (
                    ...
                    <Marker 
                        ...
                        key={index} 
                        position={{ lat: parseFloat(marker.location[0]), lng: parseFloat(marker.location[1]) }}
                        draggable={false}
